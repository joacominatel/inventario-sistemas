$(document).ready(function () {
  ...
  buttonCreateUser.addEventListener("click", () => {
    ...
    // si clickeo fuera del form, se cierra
  ...
  $(document).on('click', '.fa-trash-alt', function() {
    ...
    let [nombre, apellido, workdayId] = userInfo.match(/(.*) (.*) \((\d+)\)/).slice(1);
  
    let confirmDelete = confirm(`¿Seguro que deseas borrar el usuario ${nombre} ${apellido} (${workdayId})?`);
