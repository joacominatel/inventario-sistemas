...
if (
    ...
    $query = "UPDATE usuarios SET nombre = ?, apellido = ?, marca = ?, modelo = ?, serie = ? WHERE workday_id = ?";
    $stmt = mysqli_prepare($conn, $query);
    mysqli_stmt_bind_param($stmt, 'ssssss', $nombre, $apellido, $marca, $modelo, $serie, $workday_id);
